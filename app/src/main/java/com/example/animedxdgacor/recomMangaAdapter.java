...
public class recomMangaAdapter extends RecyclerView.Adapter<recomMangaAdapter.MangaViewHolder> {

    private final List<recomMangaItem> mangaList;

    public recomMangaAdapter(List<recomMangaItem> mangaList) {
    ...
    public MangaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_recom_manga, parent, false);
        return new MangaViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MangaViewHolder holder, int position) {
        recomMangaItem currentItem = mangaList.get(position);
